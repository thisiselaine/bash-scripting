...
# Challenges: Add a test to ensure the user running the script is online. 
# Modify this script to feth the local weather report, taking the user's zip code as an argument.
